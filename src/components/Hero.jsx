                        ...
                        <div className="lg:grid lg:grid-cols-2 lg:gap-8">
                            <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                                <div className="lg:py-8">
                                    ...
                                    >
                                        <span className="rounded-full bg-primary_500 px-3 py-0.5 text-sm font-semibold leading-5 text-white font-inter">
                                            WE'RE WORKING
                                        </span>
                                    ...
                                    <h1 className="mt-4 text-4xl tracking-tight text-black sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl font-righteous">
                                        <span className="block text-primary_500">Career Description</span>
                                        <span className="block ml-40">in Cambodia</span>
                                    </h1>
                                    <p className="mt-3 text-base text-black-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl font-inter font-regular text-gray-500">
                                            ...
                                            <div className="sm:flex">
                                                <div className="mt-0 sm:mt-0 sm:ml-0">
                                                    <button
                                                        ...
                                                        className="block w-full rounded-md bg-primary_500 py-3 px-4 font-medium text-white shadow hover:bg-primary_500 focus:outline-none focus:ring-2 focus:ring-green-300 focus:ring-offset-2 focus:ring-offset-gray-900 font-inter"
                                                    >
                                                        Explore
                                                    </button>
                                                </div>
                                            ...
                                            <div className="sm:flex justify-between">
                                                <div className="">
                                                    <h1 className="mt-4 text-4xl font-bold tracking-tight text-black sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                                        <span className="block text-primary_500 sm:flex font-righteous">30+</span>
                                                    </h1>
                                                ...
                                                <div className="">
                                                    <h1 className="mt-4 text-4xl font-bold tracking-tight text-black sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                                        <span className="block text-primary_500 font-righteous">100+</span>
                                                    </h1>
                                                    <p className="mt-3 text-base text-black-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl font-inter">
                                                        Carrers
                                                    </p>
                                                ...
                                                <div className="">
                                                    <h1 className="mt-4 text-4xl font-bold tracking-tight text-black sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                                        <span className="block text-primary_500 font-righteous">20+</span>
                                                    </h1>
                                                    <p className="mt-3 text-base text-black-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl font-inter">
                                                        Roadmap
                                                    </p>
